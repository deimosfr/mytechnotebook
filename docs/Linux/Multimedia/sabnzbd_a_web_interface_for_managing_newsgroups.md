...
At the system level, [check out the optimization of extX filesystems and RAID under Linux](../Filesystems And Storage/Raid/optimization_of_extx_filesystems_and_raid_under_linux.md)
