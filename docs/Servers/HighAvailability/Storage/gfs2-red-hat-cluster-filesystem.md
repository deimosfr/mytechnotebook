...
- You must use [LVM Cluster](../RedHatClusterSuite/installation_and_configuration_of_red_hat_cluster_suite#clvmd) to be able to use GFS2 (and therefore the cluster part as well).
