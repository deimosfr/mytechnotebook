...
I created this script for the [Red Hat Satellite server](../../Servers/Misc/Remote Install/satellite_deploying_red_hat_os_via_red_hat_satellite.md) to save time when signing and sending multiple packages to a Satellite server:
